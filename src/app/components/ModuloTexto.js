        ...
        <div className="module-content">
          ...
          <div className="text-module__description">
            <p className="center-type">
              ...
              energético que te regresa a tus raíces más profundas. Los
              balineses tienen una honda conexión espiritual en la vida diaria,
              no solo para ellos sino para la humanidad. Sé que Bali te acogerá
              y te recibirá tal como lo necesitas en este momento de tu camino.
            </p>
          </div>
        </div>
        ...
        <div className="module-content">
          ...
          <div className="text-module__description">
            <p className="center-type">
              ...
              partes del mundo, dispuestos a la aventura y al autoconocimiento.
              La única regla es venir con una mente abierta.
            </p>
          </div>
        </div>
        ...
        <div className="module-content">
          ...
          <div className="text-module__description">
            <p className="center-type">
              ...
              program centrado en el desarrollo personal en el que la
              optimización de la productividad (hacer) coexiste con el cuidado
              del bienestar interno (ser).
            </p>
          </div>
        </div>
      </section>
      <p className="modulo-texto__frasecilla ">
        Nuestro ethos se resume en una frase: <br />
