    ...
    <>
      <section className="about-principal about-principal-three-columns">
        <div className="page-title-wrapper">
          <h1 className="center-type white-type">Laura Vela</h1>
          <h3 className="white-type center-type">
            Un viaje de fuera <br /> hacia dentro.
          </h3>
        </div>
      </section>
            ...
            <div className="about-inner-three-columns ">
              <div className="title-with-paragraph fill-two-columns">
                ...
                <p className="black-type">
                  Con 23 años, se convirtió en la diseñadora más joven en
                  exhibir sus diseños en la Semana de la Moda de Nueva York.
                  Trabajó para firmas de moda como Prada, Chanel y Vogue. A los
                  24, fundó su primera empresa, Laura Vela, una marca de bolsos
                  por la que fue reconocida como «joven emprendedora destacada
                  con impacto empresarial» por The New York Times, El País,
                  Vogue, Elle, Vanity Fair, Marie Claire. En el punto más alto
                  de su carrera, tocó fondo. Lo explica en sus palabras: «Mi
                  vida parecía un sueño, pero a nivel personal no encontré la
                  plenitud. Me arrodillé, me miré con honestidad y me di cuenta
                  de que, a pesar de haber logrado lo que nuestra sociedad
                  considera deseable, no estaba conectada con mi esencia. Había
                  dejado de ser feliz». 
                </p>
              </div>
            </div>
            ...
            >
              <div className="title-with-paragraph fill-four-center-columns second-block-content">
                ...
                <div className="text-block-long">
                  <p className="black-type">
                    Tras poner fin a la etapa de Nueva York, Laura viajó a
                    África con el deseo de contribuir con acciones sociales. En
                    Kenia implementó un plan de microcréditos para mejorar la
                    economía de las clases más desfavorecidas. 
                    <br />
                    <br />
                    En 2019, recibió el reconocimiento de la organización One
                    Young World para representar a España en la cumbre mundial
                    de jóvenes líderes con impacto social.  
                    <br />
                    <br />
              ...
              >
                ...
                <div className="text-block-long">
                  <p className="black-type">
                    ...
                    (Human) con su fuerza vital (Mana). Tiene la experiencia y
                    el don de guiar a personas para potenciar el rendimiento
                    profesional y el balance personal. Dirige y mentoriza
                    procesos para diseñar una vida afín a la verdadera
